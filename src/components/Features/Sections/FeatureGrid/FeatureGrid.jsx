...
// Consolidated feature groups (from 19 cards → 9 groups)
const features = [
  {
    icon: (
  ...
  },
  {
    ...
    description:
      'Deep integrations with GitHub, GitLab, Bitbucket, and any Git host. Built-in Git with intelligent caching cuts clone time dramatically.',
  ...
  },
  {
    ...
    description:
      'Store, version, and distribute build outputs. Deploy to Kubernetes or Docker with zero downtime using canary strategies and environment-specific secrets.',
  ...
  },
  {
    ...
    description:
      'Authorize, monitor, and configure build agents across Windows, Linux, and macOS. Set capability requirements to route builds to the right agent automatically.',
  ...
  },
  {
    ...
    description:
      'Install Server, Agent, and MongoDB in minutes with a single installer. Native support for Windows, Linux, and macOS. Get running from zero in under 5 minutes.',
          ...
          >
            ...
            {feature.videoId && (
              <div className={styles.buttonRow}>
                ...
                {feature.dojoLink && (
                  <Link href={feature.dojoLink} className={styles.dojoBadge}>
