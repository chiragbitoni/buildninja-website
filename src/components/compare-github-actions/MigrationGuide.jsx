  ...
  return (
    <section className={s.section}>
      <div className={s.container}>
        ...
        >
          Switching from GitHub Actions to BuildNinja - 4 Steps
        </motion.h2>
        <motion.p
        ...
        <div className={s.stepsGrid}>
          ...
          >
            ...
            <p>
              Connect GitHub via OAuth. BuildNinja sets up webhooks automatically. Your repos stay on GitHub - only the build runner changes.
            </p>
