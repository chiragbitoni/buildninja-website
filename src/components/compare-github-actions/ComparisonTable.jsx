  ...
  return (
    <section className={s.section} id="comparison-table">
      <div className={s.container}>
        ...
        <p className="section-subtitle" style={{ margin: '0 auto', maxWidth: '1000px' }}>
          ...
          <table className={s.cmp} aria-label="BuildNinja vs GitHub Actions feature comparison">
            <thead>
              <tr>
                ...
                <th className={s.thGh}><img src="/resources/github-actions-logo.svg" alt="GitHub Actions" className={s.logoGh} /></th>
              </tr>
            </thead>
            <tbody>
              {/* PRICING */}
              ...
              <tr>
                ...
                <td className={s.tdGh}>$0.006/min Linux · $0.010/min Windows · $0.048/min macOS</td>
              </tr>
              <tr>
                <td>Self-hosted runner orchestration fee</td>
                <td className={s.tdBn}><span className={s.icYes}><Check aria-label="Yes" size={16} color="currentColor" style={{ verticalAlign: 'middle', display: 'inline-block' }} /></span> <strong>$0.00</strong> - included</td>
                <td className={s.tdGh}><span className={s.icYes}><Check aria-label="Yes" size={16} color="currentColor" style={{ verticalAlign: 'middle', display: 'inline-block' }} /></span> Free for self-hosted runners</td>
              </tr>
              <tr>
                ...
                <td className={s.tdGh}>GitHub Team: $4.00/user/mo · Enterprise: $21/user/mo</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className={s.tdBn}><span className={s.icYes}><Check aria-label="Yes" size={16} color="currentColor" style={{ verticalAlign: 'middle', display: 'inline-block' }} /></span> <strong>$10–50/mo</strong> (your own server)</td>
                <td className={s.tdGh}>$80–212/mo (plan + overages)</td>
              </tr>
              ...
              <tr>
                ...
                <td className={s.tdBn}><span className={s.icYes}><Check aria-label="Yes" size={16} color="currentColor" style={{ verticalAlign: 'middle', display: 'inline-block' }} /></span> Any provider - GitHub, GitLab, Bitbucket, Azure Repos, AWS Code Commit <span className={`${s.tagWin} ${s.tagBn}`}>BN Wins</span></td>
                <td className={s.tdGh}>GitHub only (tightly coupled)</td>
              </tr>
              <tr>
                <td>Self-hosted setup complexity</td>
                <td className={s.tdBn}><span className={s.icYes}><Check aria-label="Yes" size={16} color="currentColor" style={{ verticalAlign: 'middle', display: 'inline-block' }} /></span>  Docker, Kubernetes, or Installer on Windows, macOS, and Linux <span className={`${s.tagWin} ${s.tagBn}`}>BN Wins</span></td>
                <td className={s.tdGh}>Runner binary + registration + Kubernetes (for scale)</td>
              </tr>
              <tr>
                <td>Cloud SaaS option</td>
                <td className={s.tdBn}><span className={s.icYes}><Check aria-label="Yes" size={16} color="currentColor" style={{ verticalAlign: 'middle', display: 'inline-block' }} /></span> Self Hosted - Your infrastructure  your Rules </td>
                <td className={s.tdGh}><span className={s.icYes}><Check aria-label="Yes" size={16} color="currentColor" style={{ verticalAlign: 'middle', display: 'inline-block' }} /></span> Fully managed SaaS</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className={s.tdBn}><span className={s.icYes}><Check aria-label="Yes" size={16} color="currentColor" style={{ verticalAlign: 'middle', display: 'inline-block' }} /></span> UI based and Buildninja.Yaml can also be used</td>
              ...
              <tr>
                ...
                <td className={s.tdBn}><span className={s.icYes}><Check aria-label="Yes" size={16} color="currentColor" style={{ verticalAlign: 'middle', display: 'inline-block' }} /></span> BuildNinja Intelligence - failure prediction, log AI <span className={`${s.tagWin} ${s.tagBn}`}>BN Unique</span></td>
              ...
              <tr>
                ...
                <td className={s.tdBn}><span className={s.icYes}><Check aria-label="Yes" size={16} color="currentColor" style={{ verticalAlign: 'middle', display: 'inline-block' }} /></span> Single BuildNinja instance, all 5 providers <span className={`${s.tagWin} ${s.tagBn}`}>BN Wins</span></td>
              ...
              <tr>
                ...
                <td className={s.tdBn}><span className={s.icYes}><Check aria-label="Yes" size={16} color="currentColor" style={{ verticalAlign: 'middle', display: 'inline-block' }} /></span> Email-based notifications</td>
              ...
              <tr>
                ...
                <td className={s.tdBn}><span className={s.icYes}><Check aria-label="Yes" size={16} color="currentColor" style={{ verticalAlign: 'middle', display: 'inline-block' }} /></span> Complete Documentation Available</td>
