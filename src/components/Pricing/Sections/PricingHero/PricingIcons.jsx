...
export const FreeIcon = () => (
  <svg width="32" height="32" viewBox="0 0 54.38 65.98" style={{ color: 'var(--color-primary)' }}>
...
export const EnterpriseIcon = () => (
  <svg width="42" height="42" viewBox="0 0 102.58 149.34" style={{ color: 'var(--color-accent, #ff6135)' }}>
