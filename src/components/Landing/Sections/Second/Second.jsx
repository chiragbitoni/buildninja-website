...
const features = [
    {
        ...
        description: 'Trigger builds automatically on schedule, commit, or custom event. Multi-environment support (dev, staging, production) with intelligent retry and dependency resolution.',
    ...
    },
    {
        ...
        description: 'Role-based access control (RBAC) at project and system level. SSO with SAML 2.0, LDAP, OAuth. AES-256 encryption for all secrets.',
