        ...
        <section>
            ...
            <div className="fourthfeatures-root">
                ...
                <div className="fourthfeatures-columns">
                    {fourthSectionText.columns.map((column, idx) => (
                        <div className="fourthfeatures-card" key={column.heading}>
                            <div className="fourthfeatures-header">
                                <img src={column.heading === "Core Platform" ? paths.icons.server : paths.icons.shield} className="fourthPricingHeaderIcon"></img>
                                <span className="fourthfeatures-card-title">{column.heading}</span>
                            </div>
                            <ul className="fourthfeatures-list">
                                {column.features.map((feature, index) => (
                                    <li key={index}>
                                        <img src={paths.icons.greenTick} className="fourthPricingTickIcon" alt="tick" />
                                        {feature}
                                    </li>
                                ))}
                            </ul>
