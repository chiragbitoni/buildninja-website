        ...
        <section className="downloadAccessHeroSection">
            <div className="downloadAccessHeroContent">
                ...
                <div className="downloadAccessHeroHeader">
                    <img className="downloadAccessHeroTick" src={paths.icons.greenCircleTickOverLapWithBG} alt="Grapecity Green Tick With Background"/>
                ...
                <div className="downloadAccessHeroBottom">
                    <div className="downloadAccessHeroBottomItem">
                        <img src={paths.icons.codeFile} alt="Grapecity Code File Icon"/>
                    ...
                    <div className="downloadAccessHeroBottomItem">
                        <img src={paths.icons.book} alt="Grapecity Code File Icon"/>
                    ...
                    <div className="downloadAccessHeroBottomItem">
                        <img src={paths.icons.database} alt="Grapecity Database Icon"/>
