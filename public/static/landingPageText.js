  ...
  cards: [
    {
      ...
      iconHover: paths.icons.landingPageAssets.automated_builds_pink,
    ...
    {
      icon: paths.icons.landingPageAssets.version_control,
    ...
    {
      icon: paths.icons.landingPageAssets.artifact,
      iconHover: paths.icons.landingPageAssets.artifact_pink,
    ...
    {
      icon: paths.icons.landingPageAssets.container,
      iconHover: paths.icons.landingPageAssets.containerPink,
    ...
    {
      icon: paths.icons.landingPageAssets.shield,
      iconHover: paths.icons.landingPageAssets.shield_pink,
    ...
    {
      icon: paths.icons.landingPageAssets.agent_requirements,
      iconHover: paths.icons.landingPageAssets.agent_requirements_pink,
    ...
    {
      icon: paths.icons.landingPageAssets.interactive_dashboard,
      iconHover: paths.icons.landingPageAssets.interactive_dashboard_pink,
    ...
    {
      icon: paths.icons.landingPageAssets.trigger,
      iconHover: paths.icons.landingPageAssets.trigger_pink,
    ...
    {
      icon: paths.icons.landingPageAssets.email,
    ...
    {
      icon: paths.icons.landingPageAssets.lock,
      iconHover: paths.icons.landingPageAssets.lock_pink,
