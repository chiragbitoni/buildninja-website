    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: `Server Requirements: Minimum: 2-core CPU (x64/AMD64), 4GB RAM, 20GB storage. Recommended: 4+ cores, 8–16GB RAM, 100GB+ SSD. Requires MongoDB and Docker. Build Agents: Minimum: 2-core CPU, 2GB RAM, 10GB storage. Recommended: 4+ cores, 4–8GB RAM, 50GB+ storage. Supports Windows 10/11, and Linux. See complete system requirements for network, browser compatibility, and additional tools.`,
        },
        {
          question: "Do I need a license to use BuildNinja?",
          answer: `<p>Your first download includes a trial license (30 days, 10 users, 3 concurrent builds) — no license key needed. After the trial, acquire a license through the BuildNinja License Portal: Solo Edition (Free forever): Register and generate your free license key. Shogun Edition ($199/month): Purchase and generate your license key. Activate your license through Settings > Manage License (online or offline activation available).</p>`,
        },
        {
          question: "What infrastructure do I need for BuildNinja?",
          answer: `<p>BuildNinja runs on your infrastructure—whether that's existing on-premise servers, AWS, Azure, GCP, or any Docker-compatible environment. Minimum requirements: 2-core CPU, 4GB RAM for the server, and 2GB RAM per build agent. The key advantage: you control your infrastructure costs with no per-minute build charges, no data egress fees, and no surprise cloud bills. Use existing servers at zero additional cost, or deploy on cloud infrastructure you already manage. See complete system requirements in our documentation.</p>`,
        },
        {
      ...
      faqs: [
        {
          ...
          answer: `BuildNinja offers two plans: Solo (Free) – perfect for individual developers, includes 1 user, 3 concurrent builds, and essential features. Shogun ($199/month) – designed for teams, includes 10 users, 3 concurrent builds (with option to add more at $25/build/month), SSO support, priority support, and all features.`,
        },
        {
          question: "How does pricing work for growing teams?",
          answer: `<p>BuildNinja charges based on concurrent agents, not team size. Shogun Edition ($199/month) includes unlimited users and unlimited concurrent agents. Add your 11th, 50th, or 500th developer—your price stays the same. Solo Edition supports up to 10 users with 3 concurrent agents (additional agents at $25/month). You only pay for infrastructure capacity, never per developer.</p>`,
        },
        {
        ...
        },
        {
          ...
          answer: `<p>Yes! Annual billing saves you 33% compared to monthly - just $133/month (billed annually at $1,599) versus $199/month. We also offer multi-year plans with even greater savings: 2-year upfront at $107/month (save $1,218) and 3-year upfront at $89/month (save $1,320). As an early adopter benefit, the first 100 customers receive price lock guarantees on multi-year plans, plus free migration assistance and 20 hours of professional services with annual subscriptions.</p>`,
        },
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: `<p>BuildNinja provides a centralized management interface for all your build agents. When a new agent registers with the server, it appears in an unauthorized state - you must explicitly authorize it before it can execute builds. Once authorized, you can enable/disable agents, refresh configurations, reset status, delete agents, and filter by operating system or status. Agents support Windows and Linux, giving you flexibility to match build requirements with the right platform.</p>`,
        },
        {
        ...
        },
        {
          ...
          answer: `<p>A concurrent agent is one build agent executing a build at the same time. With 3 concurrent agents, you can run 3 builds simultaneously—additional builds queue automatically. Example: A team of 20 developers typically runs fine with 3-5 concurrent agents, while 50+ developers may need 5-10. Solo Edition includes 3 concurrent agents (add more at $25/agent/month). Shogun Edition includes unlimited concurrent agents—scale without limits.</p>`,
        },
        {
          question: "What kind of notifications does BuildNinja send?",
          answer: `<p>BuildNinja sends email notifications for build events configured at the build configuration level. You can set up notifications for build success, failure, or completion with customizable recipients (To, CC, BCC), email templates, subject lines, and trigger conditions. Multiple notifications can be configured for different events within the same build configuration. Administrators configure the system-wide SMTP notifier, while project users create notification rules using that configuration.</p>`,
        },
        {
          question: "Can I see real-time build logs?",
          answer: `<p>Yes! BuildNinja provides detailed execution logs with timestamped, step-by-step records of your build process. You can search logs using keywords, filter by category (VCS, Runner, or System), and export complete logs as CSV files for offline analysis. Build results include an Overview tab showing trigger information and duration, an Execution Logs tab for detailed build steps, and an Artifacts tab for generated files. Note: Logs are limited to 16 MiB per build.</p>`,
        },
      ],
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: `<p>Yes! BuildNinja supports SSO integration with five major identity providers: Microsoft (Azure AD), GitHub, GitLab, Google, and Bitbucket. Solo Edition includes 1 SSO provider, while Shogun Edition includes all 5 providers. SSO streamlines user authentication, increases security, and improves user experience by eliminating the need for multiple passwords. Administrators can configure SSO through the Settings panel with Client ID, Client Secret, Auth URL, and Token Endpoint configuration.</p>`,
        },
        {
        ...
        },
        {
          ...
          answer: `<p>Yes, BuildNinja provides administrator-level user management capabilities. Administrators can approve or reject user registration requests, reset passwords, block or unblock users, and export audit logs for compliance. Solo Edition supports up to 10 users, while Shogun Edition supports unlimited users. Note: Role-based access control (RBAC) is planned for a future release.</p>`,
        },
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: `<p>Annual Shogun subscriptions include 20 hours of professional services covering setup consultation, custom workflow configuration, best practices review, and troubleshooting. Free migration assistance helps you move up to 10 projects from Jenkins, GitLab CI, Azure DevOps, or other platforms—including pipeline conversion guidance and initial configuration. After 20 hours, additional services available at $150/hour. Plus, get 25% credit for your remaining CI/CD license value (max 50% of BuildNinja subscription). Contact hello@grapehub.io to get started.</p>`,
        },
      ],
    },
  ],
